...
CREATE TABLE `bill` (
  ...
  `date` char(30) DEFAULT current_timestamp()
...
(2, b'1', 30000000, 1, '2022-1-16'),
(4, b'1', 15000000, 1, '2022-1-16'),
(5, b'1', 15000000, 1, '2022-2-16'),
(6, b'1', 20000000, 1, '2022-3-16'),
(7, b'1', 20000000, 1, '2022-1-16'),
(8, b'1', 65000000, 1, '2022-3-13'),
(9, b'1', 70000000, 1, '2022-3-17'),
(10, b'1', 775000, 1, '2022-8-17'),
(12, b'1', 140000000, 2, '2022-10-13'),
(13, b'1', 17900000, 2, '2022-12-17'),
(14, b'1', 600000, 2, '2022-12-17'),
(16, b'1', 89000000, 3, '2022-6-11'),
(17, b'1', 120400000, 3, '2022-8-11');
